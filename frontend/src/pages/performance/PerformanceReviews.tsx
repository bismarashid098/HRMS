                    ...
                    <TableRow key={r._id} hover>
                      ...
                      <TableCell>
                        {r.rating ? (
                          <Chip
                            label={r.rating}
                            color={ratingColor[r.rating] || 'default'}
                            size="small"
                          />
                        ) : (
                          '—'
          ...
          {viewing && (
            <Stack spacing={1} mt={1}>
              <Typography variant="body2">
                <b>Type:</b> {viewing.type}
              </Typography>
              <Typography variant="body2">
                <b>Period:</b> {new Date(viewing.period.from).toLocaleDateString()} –{' '}
                {new Date(viewing.period.to).toLocaleDateString()}
              </Typography>
              {viewing.overallScore != null && (
                <Typography variant="body2">
                  <b>Score:</b> {viewing.overallScore}/10
                </Typography>
              )}
              {viewing.rating && (
                <Typography variant="body2">
                  <b>Rating:</b> {viewing.rating}
                </Typography>
              )}
              <Typography variant="body2">
                <b>Status:</b> {viewing.status}
              </Typography>
            </Stack>
          )}
        </DialogContent>
